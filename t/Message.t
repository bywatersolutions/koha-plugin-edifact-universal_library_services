...
use Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::Edifact;
...
my $edi = Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::Edifact->new(
    { transmission => $invoic } );
...
isa_ok( $msg,
    'Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::Edifact::Message',
...
subtest 'shipment_charge sums per plugin shipment_charges_moa_* settings' => sub {
    ...
    my $stub_plugin = sub {
        ...
        bless { _settings => \%settings },
            'Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::TestStub';
    };

    {
        no strict 'refs';
        *{'Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::TestStub::retrieve_data'}
