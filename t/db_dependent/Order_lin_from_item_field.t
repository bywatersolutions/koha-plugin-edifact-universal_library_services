...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices;
use Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactUniversalLibraryServices::Edifact::Order
        ->new(
        {
